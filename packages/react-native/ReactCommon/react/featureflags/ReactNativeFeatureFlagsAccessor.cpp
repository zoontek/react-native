 ...
 *
 * @generated SignedSource<<6ce7b0543f3e2413da88025c9e922c9a>>
 */
...
bool ReactNativeFeatureFlagsAccessor::enableAndroidAutoOffscreenCompositingForElevation() {
  auto flagValue = enableAndroidAutoOffscreenCompositingForElevation_.load();
...
bool ReactNativeFeatureFlagsAccessor::enableFabricCommitBranchingMergeOnMainThread() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(23, "enableFabricCommitBranchingMergeOnMainThread");
...
bool ReactNativeFeatureFlagsAccessor::enableFlexboxAutoMinSizeInStrictMode() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(25, "enableFlexboxAutoMinSizeInStrictMode");
...
bool ReactNativeFeatureFlagsAccessor::enableIOSCompressedTextFrameAdjustment() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(27, "enableIOSCompressedTextFrameAdjustment");
...
bool ReactNativeFeatureFlagsAccessor::enableImageTransparentTintColor() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(31, "enableImageTransparentTintColor");
...
bool ReactNativeFeatureFlagsAccessor::enableImperativeEvents() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(33, "enableImperativeEvents");
...
bool ReactNativeFeatureFlagsAccessor::enableMountingCoordinatorPullModelAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(41, "enableMountingCoordinatorPullModelAndroid");
...
bool ReactNativeFeatureFlagsAccessor::enableMutationObserverByDefault() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(42, "enableMutationObserverByDefault");
...
bool ReactNativeFeatureFlagsAccessor::enableNativeCSSParsing() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(43, "enableNativeCSSParsing");
...
bool ReactNativeFeatureFlagsAccessor::enableResizeObserverByDefault() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(46, "enableResizeObserverByDefault");
...
bool ReactNativeFeatureFlagsAccessor::fixDifferentiatorParentTagForUnflattenCase() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(55, "fixDifferentiatorParentTagForUnflattenCase");
...
bool ReactNativeFeatureFlagsAccessor::fuseboxWebSocketEventsEnabled() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(62, "fuseboxWebSocketEventsEnabled");
...
bool ReactNativeFeatureFlagsAccessor::viewTransitionEnabled() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(86, "viewTransitionEnabled");
...
bool ReactNativeFeatureFlagsAccessor::viewTransitionUseHardwareBitmapAndroid() {
  ...
  if (!flagValue.has_value()) {
    ...
    markFlagAsAccessed(87, "viewTransitionUseHardwareBitmapAndroid");
